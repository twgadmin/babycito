        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.pages.store') }}" class="number-tab-steps wizard-circle" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="slug" name="slug" maxlength="190" value="{{ old('slug') }}"  class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" maxlength="190" value="{{ old('meta_title') }}"  class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                                <input type="checkbox" class="custom-control-input" id="customSwitch4" name="is_system_page" value="1">
                                        ...
                                        <div class="form-group">
                                            <a href="{!! URL::route('admin.media-files.create') !!}" target="blank">Add New Media</a>
                                             ...
                                             @if (isset($mediaFile) && count($mediaFile) > 0)
                                                ...
                                                <label>
                                                    <input type="radio" name="media_file_id" value="{!! $media->id !!}" data='{!! asset(uploadsDir('front') . $media->filename) !!}'>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" maxlength="65000" rows="5" class="form-control ckeditor">{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" maxlength="65000" rows="5" class="form-control ckeditor">{{ old('meta_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
