...
<body>
    <div style="background-color: #f4f4f4; padding:10px; margin:auto; font-family: Arial, Helvetica, sans-serif; line-height:30px; ">
           ...
           <p><b>Hi {{ $vendorname }},</b></p>
            <p>{{ $username }} would like to request a price quote for the following Service:-</p>
            <p><strong>{{ $serviceName }}</strong></p>
            <p>Please feel free to call me if you need any further information in order to provide us with a firm price.</p>
